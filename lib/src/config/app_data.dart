...
ItemModel apple = ItemModel(
  ...
  unit: "kg",
  price: 5.5,
  description: 'A melhor maçã da região e o melhor preço de qualquer quitanda. Este item tem vitaminas essenciais para o fortalecimento corporal, resultando em uma vida saudável.',
);
